...
namespace Abbybot_III.Commands.Normal.Gelbooru
{
    ...
    class cfc : NormalCommand
    {
        public override async Task DoWork(AbbybotCommandArgs a)
        {
            ...
            var cfc = await AutoFcDmSql.GetFCMAsync(a.abbybotGuild.GuildId, a.channel.Id);
            ...
            if (FavoriteCharacter.Length > 1)
            {
                ...
                if (s == "remove")
                {
                    await AutoFcDmSql.SetCFCAsync(a.abbybotGuild.GuildId, a.channel.Id, "NO");
                    return;
                }
            }
            ...
            if (canrun)
            {
                await AutoFcDmSql.SetCFCAsync(a.abbybotGuild.GuildId, a.channel.Id, FavoriteCharacter.ToString());
